...
local Window = OrionLib:MakeWindow({Name = "Ducke Scripts Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Ducke Scripts Hub"})

OrionLib:MakeNotification({
	Name = "Ducke Scripts Hub",
...
W:AddLabel("[+] Ducke Scripts Hub is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Ducke Scripts Hub(Noitification)",
